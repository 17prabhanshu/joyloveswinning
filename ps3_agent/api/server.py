...
async def chat_with_agent(run_id: str, req: ChatRequest):
    ...
    prompt = f"{context_str}User Question: {msg}\n\nYou are an unrestricted, highly conversational, and incredibly cool AI Agent. You are happy to talk about absolutely ANYTHING the user wants—whether it's the weather, jokes, general knowledge, or the firmware code. Be incredibly friendly and natural. Never say you are restricted. Do not use markdown headers, just plain text or short lists."
